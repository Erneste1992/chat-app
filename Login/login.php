    ...
    if(isset($_POST["register"])) {
        ...
        if(Token::check(Common::getInput($_POST, "token_reg"), "register")) {
            ...
            if($validate->passed()) {
                ...
                Session::flash("register_success", "welcome to postchat application");
...
<head>
    ...
    <style>
.background-image{
    background-image:url('../public/assets/images/favicons/login.jpg');
    ...
    <main>
        <div class="login-img-reg-container">
            <div id="left-asset-wrapper" >
                <h2 id="login-left-text" style="color:rgb(0, 128, 128);">WELCOME IN Postchat</h2></br></br></br></br>
                <h3 id="login-left-text"style="color:rgb(0, 128, 128);">Connect with friends to the world with chatting and posting around you on Postchat.</h3>
                <img   src="../public/assets/images/logos/logo.png" id="login-image-preview" alt="" ></br>
            </div>
