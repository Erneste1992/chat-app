...
<header>
    <div id="top-header">
        <div id="header-logo-container">
            ...
            <a href="<?php echo Config::get("root/path");?>index.php" style="height: 120px"><img src="<?php echo Config::get("root/path");?>" alt="" id=""><h1 style="color:gray;font-size:30px; ">Postchat</h1> </a>
        </div>
