...
<div id="setting-left-pannel">
    <div id="setting-panel-header-logo-box">
        <a href="<?php echo $index_page_path ?>" class="flex"><img src="<?php echo $logo_path ?>" id="" alt=""><h1 style="color:gray;font-size:30px; ">Postchat</h1> </a>
    </div>
    <div class="flex">
        <a href="<?php echo $index_page_path ?>" class="flex link go-back-to right-pos-margin" style="margin-right: 6px">Go back to Postchat</a>
    </div>
