...
use models\{User, Message};
    ...
    class ChatComponent {
        public static function generate_chat_page_friend_contact($current_user_id, $user) {
            ...
            $user_picture = Config::get("root/path") . (empty($user->getPropertyValue("picture")) ? "public/assets/images/logos/logo.png" : $user->getPropertyValue("picture"));
...
EOS;
        ...
        public static function generate_chat_section($sender, $receiver) {
            ...
            $friend_picture = empty($rcv->getPropertyValue("picture")) ? "public/assets/images/logos/logo.png" : $rcv->getPropertyValue("picture");
...
CHAT_SECTION;
        ...
        public static function generate_current_user_message($user, $message, $message_date) {
            $user_profile = Config::get("root/path") .  (empty($user->getPropertyValue("picture")) ? "public/assets/images/logos/logo.png" : $user->getPropertyValue("picture"));
...
FM;
        ...
        public static function generate_sender_reply_message($original_message_id, $reply_message_id, $original_message_creator_id, $reply_creator_id) {
            ...
            $reply_message_picture = Config::get("root/path") . (empty($reply_message_owner->getPropertyValue("picture")) ? "public/assets/images/logos/logo.png" : $reply_message_owner->getPropertyValue("picture"));
...
FM;
        ...
        public static function generate_discussion($current_user_id, $discussion) {
            ...
            */
            ...
            $friend_picture = Config::get("root/path") . (empty($friend_user->getPropertyValue("picture")) ? 'public/assets/images/logos/logo.png' : $friend_user->getPropertyValue("picture"));
