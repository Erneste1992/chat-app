<?php
    ...
    class Post {
        ...
        function generate_post($post, $user) {
            ...
            $post_owner_picture = Config::get("root/path") . (($post_owner_user->getPropertyValue("picture") != "") ? $post_owner_user->getPropertyValue("picture") : "public/assets/images/logos/larg.png");
