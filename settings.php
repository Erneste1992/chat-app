...
$picture = $root . (empty($user->getPropertyValue("picture")) ? "public/assets/images/logos/larg.png" : $user->getPropertyValue("picture"));
        ...
        <div id="setting-master-container">
            ...
            <div>
                ...
                <div id="profile-asset-wrapper" class="flex">
                    ...
                    <div id="setting-file-inputs-container">
                        ...
                        <div style="margin-top: 10px">
                            <label for="avatar-input" class="setting-label" style="font-size: 16px; margin-bottom: 5px">your photo </label>
                ...
                <div style="margin-top: 26px">
                    <label for="fullname" class="setting-label1">About You</label>
                    <p class="input-hint">You can have up to 12 items displayed as a table on your profile</p>
                    <div class="flex">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[0]["label"] ?>" placeholder="Country" name="label1" id="label1">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[0]["content"] ?>" placeholder="Province" name="content1" id="content1">
                    </div>
                    <div class="flex">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[1]["label"] ?>" placeholder="District" name="label2" id="label2">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[1]["content"] ?>" placeholder="Sector" name="content2" id="content2">
                    </div>
                   
                    <div class="flex">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[3]["label"] ?>" placeholder="Where Studied at Primary" name="label4" id="label4">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[3]["content"] ?>" placeholder="Where Studied at Secondary" name="content4" id="content4">
                    </div>
                    <div class="flex">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[4]["label"] ?>" placeholder="Where Studied at Secondary" name="label5" id="label5">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[4]["content"] ?>" placeholder="Where Studied at University" name="content5" id="content5">
                    </div>
                    <div class="flex">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[5]["label"] ?>" placeholder="Hobbies" name="label6" id="label6">
                        <input type="text" form="save-form" class="setting-input-text-style meta-data-input" value="<?php echo $user_metadata[5]["content"] ?>" placeholder="telephone" name="content6" id="content6">
                    </div>
                </div>
